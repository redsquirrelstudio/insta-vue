(function (global, factory) {
  ...
  __vue_render__._withStripped = true;
    ...
    var __vue_inject_styles__ = function (inject) {
      if (!inject) { return }
      inject("data-v-c5152a08_0", { source: "\n.insta-vue[data-v-c5152a08] {\n  display: flex;\n  flex-wrap: wrap;\n  width: 100%;\n}\n.insta-vue .post[data-v-c5152a08] {\n  display: block;\n  box-sizing: border-box;\n  padding: 10px;\n  height: auto;\n}\n.insta-vue .post img[data-v-c5152a08] {\n  width: 100%;\n}\n.insta-vue p[data-v-c5152a08]{\n  margin-top: 0.5rem;\n  width: 100%;\n  font-size: 0.9rem;\n  color: #FFF;\n  mix-blend-mode: difference;\n}\n", map: {"version":3,"sources":["/srv/http/insta-vue/src/InstaVue.vue"],"names":[],"mappings":";AA6FA;EACA,aAAA;EACA,eAAA;EACA,WAAA;AACA;AAEA;EACA,cAAA;EACA,sBAAA;EACA,aAAA;EACA,YAAA;AACA;AAEA;EACA,WAAA;AACA;AAEA;EACA,kBAAA;EACA,WAAA;EACA,iBAAA;EACA,WAAA;EACA,0BAAA;AACA","file":"InstaVue.vue","sourcesContent":["<template>\n  <div class=\"insta-vue\">\n    <div @click.prevent=\"link(post.url)\" class=\"post\"\n         :style=\"`${links ? 'cursor: pointer;' : 'cursor: default;'} width: ${100 / cols}%;`\"\n         v-for=\"post in posts\" :key=\"post.id\">\n      <img :alt=\"post.alt\" :src=\"post.src\">\n      <p class=\"description\" v-if=\"descriptions\">{{ post.description }}</p>\n    </div>\n  </div>\n</template>\n<script>\nexport default {\n  name: 'InstaVue',\n  props: {\n    tag: {\n      type: String,\n      required: true,\n    },\n    quantity: {\n      type: Number,\n      default: 4,\n    },\n    cols: {\n      type: Number,\n      default: 4,\n    },\n    links: {\n      type: Boolean,\n      default: false,\n    },\n    descriptions: {\n      type: Boolean,\n      default: false,\n    }\n  },\n  data() {\n    return {\n      posts: [],\n    }\n  },\n  mounted() {\n    this.getPosts();\n  },\n  methods: {\n    link(url) {\n      if (this.links) {\n        window.open( url, '_blank');\n      }\n    },\n    getPosts() {\n      if (this.tag[0] === '#') {\n        fetch(`https://www.instagram.com/explore/tags/${this.tag.replace('#', '')}/?__a=1`)\n            .then((response) => {\n              response.json().then((data) => {\n                if (data.hasOwnProperty('graphql')) {\n                  for (let i = 0; i < this.quantity; i++) {\n                    let post = data.graphql.hashtag.edge_hashtag_to_media.edges[i].node;\n                    this.posts.push({\n                      id: post.id,\n                      src: post.display_url,\n                      url: `https://www.instagram.com/p/${post.shortcode}/`,\n                      alt: post.accessibility_caption,\n                      description: post.edge_media_to_caption.edges[0]['node']['text'],\n                    });\n                  }\n                }\n              });\n            });\n      } else {\n        fetch(`https://www.instagram.com/${this.tag}/?__a=1`)\n            .then(response => {\n              response.json().then((data) => {\n                if (data.hasOwnProperty('graphql')) {\n                  for (let i = 0; i < this.quantity; i++) {\n                    let post = data.graphql.user.edge_owner_to_timeline_media.edges[i].node\n                    this.posts.push({\n                      id: post.id,\n                      src: post.display_url,\n                      url: `https://www.instagram.com/p/${post.shortcode}/`,\n                      alt: post.accessibility_caption,\n                      description: post.edge_media_to_caption.edges[0]['node']['text'],\n                    });\n                  }\n                }\n              });\n            });\n      }\n    }\n  },\n}\n</script>\n\n<style scoped>\n.insta-vue {\n  display: flex;\n  flex-wrap: wrap;\n  width: 100%;\n}\n\n.insta-vue .post {\n  display: block;\n  box-sizing: border-box;\n  padding: 10px;\n  height: auto;\n}\n\n.insta-vue .post img {\n  width: 100%;\n}\n\n.insta-vue p{\n  margin-top: 0.5rem;\n  width: 100%;\n  font-size: 0.9rem;\n  color: #FFF;\n  mix-blend-mode: difference;\n}\n</style>"]}, media: undefined });

    };
    /* scoped */
    var __vue_scope_id__ = "data-v-c5152a08";
    /* module identifier */
